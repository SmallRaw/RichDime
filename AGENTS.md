...
# 清理缓存
pnpm clean
pnpm clean:all          # 深度清理（含 .expo 和 node_modules/.cache）
```
...
- **MUST** patched 依赖使用精确版本
  当前 patch: `expo-sqlite@15.2.14`
  修改 patch 需要明确批准。
...
| 日期 | 规则 | 起因 | 类型 |
|------|------|------|------|
| 2026-02-01 | 初始化项目规范 | 使用 architect-skill 初始化 | 初始化 |
